...
import com.hardrock.mongo.MongoConnectionException;
...
public class MongoUtil {
	...
	public static Date parseMongoDateTime(String dateTime) {
		...
		long timeMills = DateUtils.MILLIS_PER_DAY * days + (hour - 8)
				* DateUtils.MILLIS_PER_HOUR + minute
				* DateUtils.MILLIS_PER_MINUTE + second
				* DateUtils.MILLIS_PER_SECOND + millSec;
		return new Date(timeMills);
	}

	public static void main(String[] args) throws InterruptedException,
			ParseException {
		System.out.println(MongoUtil.parseMongoDateTime("1970-01-27T06:44:00.0Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2014-03-27T06:44:00.000Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2013-08-27T06:44:00.000Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2013-01-08T14:04:45.968Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2015-02-28T14:46:45.968Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2008-02-29T16:00:00.000Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2008-02-28T16:00:00.000Z"));
		System.out.println(MongoUtil.parseMongoDateTime("2008-04-04T16:00:00.0Z"));
	}
}
